...
class ChoicesBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBuildingChoicesFromRepositoryMethodWhenMethodDoesNotReturnAnArray()
    {
        ...
        $this->setExpectedException('Exception', "Repository method {$methodName} must return an array of choices");
        $builder->build([
            'repository' => $repositoryName,
            'method' => $methodName,
        ]);
    ...
    public function testBuildingChoicesFromCallableWhenResultIsNotAnArray()
    {
        ...
        $this->setExpectedException('Exception', 'The provided choice callback must return an array of choices');
